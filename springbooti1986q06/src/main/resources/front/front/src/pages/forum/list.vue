<template>
<div class="forum-preview" :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
    <div :style='{"width":"100%"}'>
		<div :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"100%","lineHeight":"54px","fontSize":"20px","height":"54px"}'>留言板</div>
	</div>
    <el-form :style='{"padding":"10px","margin":"10px 0","alignItems":"center","flexWrap":"wrap","textAlign":"center","background":"#654B3C","display":"flex","width":"100%","justifyContent":"center","height":"auto"}' :inline="true" :model="formSearch" class="list-form-pv">
		<el-form-item :style='{"margin":"0 10px","justifyContent":"center","display":"flex"}'>
	...
	<div class="z-box" :style='{"width":"100%","padding":"20px 0"}'>
		<div class="section-content" v-for="item in forumList" :key="item.id" @click="toForumDetail(item)">
		  <div :style='{"color":"#333","width":"100%","fontSize":"16px"}' class="item-style">{{item.title}}</div>
		  <div :style='{"width":"100%","fontSize":"14px","color":"#333","order":"1"}' class="item-style">发布人：{{item.username}}</div>
		  <div :style='{"color":"#333","fontSize":"14px"}' class="item-style">{{item.addtime}}</div>
		</div>
	</div>
