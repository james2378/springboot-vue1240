<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231114/b02cac02c33549cda223ecdd28fe233a.png) fixed","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"flex-end"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px 80px","boxShadow":"0px 0 2px #DFDFDF","margin":"110px 10% 110px 0","borderRadius":"10px","flexWrap":"wrap","background":"rgba(255,255,255,.8)","display":"flex","width":"650px","position":"relative","justifyContent":"flex-end","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"margin":"0 0 10px 0","color":"#654B3C","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"24px","fontWeight":"600"}'>智慧养老服务系统注册</p></div>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="yonghuzhanghao">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('yonghuzhanghao')?'required':''">用户账号：</div>
			...
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="nianling">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('nianling')?'required':''">年龄：</div>
			...
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="shenfenzheng">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('shenfenzheng')?'required':''">身份证：</div>
			...
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="jifen">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('jifen')?'required':''">积分：</div>
				<el-input v-model.number="registerForm.jifen" readonly placeholder="请输入积分" />
			</el-form-item>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="yishenggonghao">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('yishenggonghao')?'required':''">医生工号：</div>
				<el-input v-model="registerForm.yishenggonghao"  placeholder="请输入医生工号" />
			</el-form-item>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="yishengxingming">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('yishengxingming')?'required':''">医生姓名：</div>
				<el-input v-model="registerForm.yishengxingming"  placeholder="请输入医生姓名" />
			</el-form-item>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="mima">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('mima')?'required':''">密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="mima2">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('mima')?'required':''">确认密码：</div>
				<el-input v-model="registerForm.mima2" type="password" placeholder="请再次输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="xingbie">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('xingbie')?'required':''">性别：</div>
                <el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
                  <el-option
			...
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="zhaopian">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('zhaopian')?'required':''">照片：</div>
                <file-upload
					tip="点击上传照片"
					action="file/upload"
					:limit="1"
			...
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="keshi">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('keshi')?'required':''">科室：</div>
			...
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="zhicheng">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('zhicheng')?'required':''">职称：</div>
				<el-input v-model="registerForm.zhicheng"  placeholder="请输入职称" />
			</el-form-item>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="gerenshanzhang">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('gerenshanzhang')?'required':''">个人擅长：</div>
				<el-input v-model="registerForm.gerenshanzhang"  placeholder="请输入个人擅长" />
			</el-form-item>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="lianxifangshi">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('lianxifangshi')?'required':''">联系方式：</div>
				<el-input v-model="registerForm.lianxifangshi"  placeholder="请输入联系方式" />
			</el-form-item>
			<el-form-item :style='{"width":"100%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yisheng'" prop="youxiang">
				<div v-if="true" :style='{"width":"110px","margin":"0 6px 0 0","lineHeight":"44px","fontSize":"14px","color":"#654b3c","textAlign":"right"}' :class="changeRules('youxiang')?'required':''">邮箱：</div>
...
export default {
    ...
    created() {
		...
		if(this.$route.query.pageFlag=='register'){
		  ...
		  if ('yonghu' == this.tableName) {
			this.rules.jifen = [{ required: true, validator: this.$validate.isIntNumer, trigger: 'blur' }];
		  }
		  if ('yisheng' == this.tableName) {
          ...
          if (valid) {
            var url=this.tableName+"/register";
               ...
               if(`yonghu` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
				...
				if(`yonghu` == this.tableName && this.registerForm.jifen &&(!this.$validate.isIntNumer2(this.registerForm.jifen))){
               ...
               if(`yisheng` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
				...
				if((!this.registerForm.mima) && `yisheng` == this.tableName){
					...
					if(`yisheng` == this.tableName && this.registerForm.youxiang &&(!this.$validate.isEmail2(this.registerForm.youxiang))){
