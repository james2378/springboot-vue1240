...
<div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="作品封面" v-if="type!='cross' || (type=='cross' && !ro.zuopinfengmian)" prop="zuopinfengmian">
            <file-upload
            tip="点击上传作品封面"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' class="upload" v-else label="作品封面" prop="zuopinfengmian">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="作品简介" prop="zuopinjianjie">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="作品简介"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="作品背景" prop="zuopinbeijing">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="作品背景"
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`yishuzihuajianshang/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
			...
			this.$refs["ruleForm"].validate(valid => {
				if(valid) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('yishuzihuajianshang/list', {
							params: params
						}).then(res => {
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`yishuzihuajianshang/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
