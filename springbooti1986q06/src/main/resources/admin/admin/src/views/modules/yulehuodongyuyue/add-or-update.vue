	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="活动内容" prop="huodongneirong">
					<el-input v-model="ruleForm.huodongneirong" placeholder="活动内容" clearable  :readonly="ro.huodongneirong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="活动内容" prop="huodongneirong">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="活动积分" prop="jifen">
					<el-input v-model.number="ruleForm.jifen" placeholder="活动积分" clearable  :readonly="ro.jifen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="活动积分" prop="jifen">
					<el-input v-model="ruleForm.jifen" placeholder="活动积分" readonly></el-input>
				</el-form-item>
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `yulehuodongyuyue/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									...
									this.$message({
										...
										onClose: () => {
											...
											this.parent.yulehuodongyuyueCrossAddOrUpdateFlag = false;
											this.parent.search();
