<template>
	<div class="main-content" :style='{"padding":"30px"}'>
			...
			<el-form class="center-form-pv" :style='{"padding":"20px 20px 10px","margin":"0 0 20px","borderRadius":"8px","background":"#fff"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' >
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#000","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">医生工号</label>
						<el-input v-model="searchForm.yishenggonghao" placeholder="医生工号" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#000","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">医生姓名</label>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('yisheng','预约')" @click="yuyuejiuzhenCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
								<span class="icon iconfont icon-xihuan" :style='{"margin":"0 2px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
								预约
							</el-button>
		...
		<yuyuejiuzhen-cross-add-or-update v-if="yuyuejiuzhenCrossAddOrUpdateFlag" :parent="this" ref="yuyuejiuzhenCrossaddOrUpdate"></yuyuejiuzhen-cross-add-or-update>
...
import yuyuejiuzhenCrossAddOrUpdate from "../yuyuejiuzhen/add-or-update";
	export default {
		data() {
			return {
				searchForm: {
				...
				yuyuejiuzhenCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			yuyuejiuzhenCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.yuyuejiuzhenCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.yuyuejiuzhenCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.yuyuejiuzhenCrossaddOrUpdate.init(row.id,type);
				});
			},
