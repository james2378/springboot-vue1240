	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商品详情" prop="shangpinxiangqing">
					<el-input v-model="ruleForm.shangpinxiangqing" placeholder="商品详情" clearable  :readonly="ro.shangpinxiangqing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="商品详情" prop="shangpinxiangqing">
					<el-input v-model="ruleForm.shangpinxiangqing" placeholder="商品详情" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商品数量" prop="shangpinshuliang">
					<el-input v-model.number="ruleForm.shangpinshuliang" placeholder="商品数量" clearable  :readonly="ro.shangpinshuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="商品数量" prop="shangpinshuliang">
					<el-input v-model="ruleForm.shangpinshuliang" placeholder="商品数量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="兑换积分" prop="duihuanjifen">
					<el-input v-model.number="ruleForm.duihuanjifen" placeholder="兑换积分" clearable  :readonly="ro.duihuanjifen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="兑换积分" prop="duihuanjifen">
					<el-input v-model="ruleForm.duihuanjifen" placeholder="兑换积分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.shangpintupian" label="商品图片" prop="shangpintupian">
					<file-upload
						tip="点击上传商品图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.shangpintupian" label="商品图片" prop="shangpintupian">
