...
public class YuyuetijianController {
    ...
    public R page(@RequestParam Map<String, Object> params,YuyuetijianEntity yuyuetijian,
		...
		if(tableName.equals("yonghu")) {
			yuyuetijian.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R update(@RequestBody Long[] ids, @RequestParam String sfsh, @RequestParam String shhf){
        List<YuyuetijianEntity> list = new ArrayList<YuyuetijianEntity>();
        for(Long id : ids) {
            YuyuetijianEntity yuyuetijian = yuyuetijianService.selectById(id);
            yuyuetijian.setSfsh(sfsh);
            yuyuetijian.setShhf(shhf);
            list.add(yuyuetijian);
        }
        yuyuetijianService.updateBatchById(list);
        return R.ok();
    }
